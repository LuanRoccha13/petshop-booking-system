          ...
          var e,
            ...
            u = (function (t, e, i, n) {
                      ...
                      s(n, `show item ${e + 1} of ${f.length}`),
                        ...
                        A(t.thumbnailUrl || t.url, function (t) {
                          t.prop("width") > t.prop("height")
                            ? P(t, "wide")
                            : P(t, "tall"),
                            i.append(P(t, "thumbnail-image"));
                        });
                    }),
                    c.strip.empty().append(c.items),
                    P(c.content, "group")),
                  u(S(c.lightbox, "hide").trigger("focus"))
                    .add("opacity .3s")
                    .start({ opacity: 1 }),
                  P(c.html, "noscroll"),
                  x.show(e || 0)
              ...
              (x.build = function () {
                return (
                  x.destroy(),
                  ((c = { html: i(e.documentElement), empty: i() }).arrowLeft =
                    j("control left inactive")
                      .attr("role", "button")
                      .attr("aria-hidden", !0)
                      .attr("aria-controls", "w-lightbox-view")),
                  (c.arrowRight = j("control right inactive")
                    .attr("role", "button")
                    .attr("aria-hidden", !0)
                    .attr("aria-controls", "w-lightbox-view")),
                  (c.close = j("control close").attr("role", "button")),
                  s(c.arrowLeft, "previous image"),
                  s(c.arrowRight, "next image"),
                  s(c.close, "close lightbox"),
                  (c.spinner = j("spinner")
                  ...
                  (c.strip = j("strip").attr("role", "tablist")),
                  (d = new O(c.spinner, D("hide"))),
                  (c.content = j("content").append(
                    c.spinner,
                    c.arrowLeft,
                    c.arrowRight,
                    c.close
                  )),
                  (c.container = j("container").append(c.content, c.strip)),
                  (c.lightbox = j("backdrop hide").append(c.container)),
                  c.strip.on("click", N("item"), I),
                  c.content
                    .on("swipe", k)
                    .on("click", N("left"), v)
                    .on("click", N("right"), b)
                    .on("click", N("close"), y)
                    .on("click", N("image, caption"), b),
                  c.container
                    .on("click", N("view"), y)
                    .on("dragstart", N("img"), C),
                  c.lightbox.on("keydown", R).on("focusin", L),
                ...
                (x.destroy = function () {
                  c &&
                    (S(c.html, "noscroll"), c.lightbox.remove(), (c = void 0));
                }),
                (x.show = function (t) {
                  if (t !== o) {
                    var e,
                      ...
                      A(
                        ...
                        function (e) {
                          if (t === o) {
                            var r,
                              a,
                              s = j("figure", "figure").append(P(e, "image")),
                              g = j("frame").append(s),
                              m = j("view")
                                .prop("tabIndex", 0)
                                ...
                                .append(g);
                            n.html &&
                              ((a = (r = i(n.html)).is("iframe")) &&
                                r.on("load", x),
                              s.append(P(r, "embed"))),
                              n.caption &&
                                s.append(
                                  j("caption", "figcaption").text(n.caption)
                                ),
                              c.spinner.before(m),
                              a || x();
                          }
              ...
              var v = w(x.prev),
                ...
                I = function (t) {
                  var e = i(this).index();
                  t.preventDefault(), x.show(e);
                },
                k = function (t, e) {
                  t.preventDefault(),
                    "left" === e.direction
                      ? x.next()
                      : "right" === e.direction && x.prev();
                },
                L = function () {
                  this.focus();
                };
              ...
              function $() {
                c &&
                  ...
                  S(c.content, "group"),
                  P(c.arrowLeft, "inactive"),
                  P(c.arrowRight, "inactive"),
                  (o = c.view = void 0),
              ...
              function j(t, n) {
                return P(i(e.createElement(n || "div")), t);
              }
              ...
              var B = t.navigator.userAgent,
                J = B.match(/(iPhone|iPad|iPod);[^OS]*OS (\d)/);
              if (
                (B.indexOf("Android ") > -1 && -1 === B.indexOf("Chrome")) ||
                (J && !(J[2] > 7))
              ) {
                var T = e.createElement("style");
                e.head.appendChild(T), t.addEventListener("resize", U, !0), U();
              }
              function U() {
                var e = t.innerHeight,
                  i = t.innerWidth,
              ...
              return x;
            })(window, document, t, d ? "#lightbox-mountpoint" : "body"),
            p = t(document),
            g = ".w-lightbox";
          function f(t) {
            var e,
