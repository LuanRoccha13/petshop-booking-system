  ...
  ["966"],
  {
    7199: function (e) {
      var n = window.jQuery,
        ...
        a = {
          ...
          intro: function (e, o) {
            o.__wf_intro ||
              ((o.__wf_intro = !0), n(o).triggerHandler(t.types.INTRO));
          },
          outro: function (e, o) {
            o.__wf_intro &&
              ((o.__wf_intro = null), n(o).triggerHandler(t.types.OUTRO));
          },
        };
      (t.triggers = {}),
        (t.types = { INTRO: "w-ix-intro" + r, OUTRO: "w-ix-outro" + r }),
        (t.init = function () {
          for (var e = o.length, r = 0; r < e; r++) {
            var i = o[r];
            i[0](0, i[1]);
          }
          (o = []), n.extend(t.triggers, a);
        }),
        (t.async = function () {
          for (var e in a) {
            var n = a[e];
    ...
    5134: function (e, n, t) {
      ...
      function r(e, n, t) {
        ...
        o.initCustomEvent(n, !0, !0, t || null), e.dispatchEvent(o);
      }
      var a = window.jQuery,
        i = {},
        s = ".w-ix";
      (i.triggers = {}),
        (i.types = { INTRO: "w-ix-intro" + s, OUTRO: "w-ix-outro" + s }),
        a.extend(i.triggers, {
          reset: function (e, n) {
            o.triggers.reset(e, n);
          },
          intro: function (e, n) {
            o.triggers.intro(e, n), r(n, "COMPONENT_ACTIVE");
          },
          outro: function (e, n) {
            o.triggers.outro(e, n), r(n, "COMPONENT_INACTIVE");
          },
        }),
        (i.dispatchCustomEvent = r),
        (e.exports = i);
    },
    1655: function (e, n, t) {
      var o = t(3949),
        ...
        (e.exports = function (e, n) {
          ...
          function _(t, o) {
            ...
            g ||
              ...
              (g.button = v.find(".w-nav-button")),
              (g.container = v.find(".w-container")),
              (g.overlayContainerId = "w-nav-overlay-" + t),
              (g.outside =
                ((r = g).outside && p.off("click" + m, r.outside),
                function (n) {
                  var t = e(n.target);
                  (d && t.closest(".w-editor-bem-EditorOverlay").length) ||
                    H(r, t);
                }));
                  ...
                  g.button.on(
                    ...
                    function (e) {
                      switch (e.keyCode) {
                        ...
                        case a.ESCAPE:
                          return j(l), e.preventDefault(), e.stopPropagation();
                        case a.ARROW_RIGHT:
                        case a.ARROW_DOWN:
                        case a.HOME:
                        case a.END:
          ...
          function I(e) {
            ...
            (t.animOver = /^over/.test(r)),
              ...
              o.animation !== r && e.open && n.defer(N, e),
            ...
            l.preview =
              function () {
                (u = g && o.env("design")),
                  (d = o.env("editor")),
                  (t = e(document.body)),
                  (s = p.find(m)).length && (s.each(_), C(), o.resize.on(R));
              }),
            (l.destroy = function () {
              (E = e()), C(), s && s.length && s.each(k);
            });
          ...
          function W(n, t) {
            ...
            if ((!o.open || r || u || j(o, !0), o.container.length)) {
              var a,
                i =
                  ("none" === (a = o.container.css(M)) && (a = ""),
                  function (n, t) {
                    (t = e(t)).css(M, ""), "none" === t.css(M) && t.css(M, a);
                  });
              o.links.each(i), o.dropdowns.each(i);
            }
            o.open && G(o);
          }
          var M = "max-width";
          ...
          function U(e, n) {
            if (!e.open) {
              (e.open = !0),
                e.menu.each(S),
                e.links.addClass(b),
                e.dropdowns.addClass(w),
                e.dropdownToggle.addClass(y),
                e.dropdownList.addClass(O),
                e.button.addClass(h);
              var t = e.config;
              ("none" === t.animation ||
                !c.support.transform ||
              ...
              if (
                ...
                i(l, "open"),
                o.redraw.up(),
                u || p.on("click" + m, e.outside),
                n)
              )
                return void v();
              var f = "transform " + t.duration + "ms " + t.easing;
              if (
                (e.overlay &&
          ...
          function G(e) {
            var n = e.config,
              o = n.docHeight ? p.height() : t.height();
            return (
              n.animOver
                ? e.menu.height(o)
                : "fixed" !== e.el.css("position") &&
                  (o -= e.el.outerHeight(!0)),
          ...
          function j(e, n) {
            ...
            function u() {
              e.menu.height(""),
                ...
                e.dropdowns.removeClass(w),
                e.dropdownToggle.removeClass(y),
                e.dropdownList.removeClass(O),
                e.overlay &&
