/*! Build a7e81f5f25c9da08aa74f824102213a3ad909706:1782911621363 */
!(function (e) {
  var t = {};
  function r(n) {
              ...
              return (
                r
                  ? ((t.cookie = i({}, r)),
                    ...
                    o.a.set(e, JSON.stringify(t), i(i({}, n), r)))
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return v(
                  "POST",
                  L.config.API_HOST + "/referrals/".concat(r, "/convert"),
                  t
                );
              },
            },
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  L.coupon &&
                    L.coupon.id &&
                    (t.coupon = R(e, "coupon", L.coupon.id)),
                  t
                );
              },
            },
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (e) {
              if (w.id) {
                var t = w.id;
                g.addSearchParamsToLink(e, { client_reference_id: t });
              }
            },
          },
        ]),
        (r = null) && x(t.prototype, r),
        n && x(t, n),
        Object.defineProperty(t, "prototype", { writable: !1 }),
        e
      );
          ...
          (n = [
            {
              ...
              value: function () {
                return document.querySelectorAll(
                  "stripe-pricing-table[data-rewardful]"
                );
              },
            },
            {
      ...
      return (
        ...
        (n = [
                ...
                ? e.apiKey
                  ? e.window
                    ? (q(),
                      ...
                      (this._paramNames = e.paramNames),
                      (this._link = new j(e.window.location)),
                      (this._setup = !0),
                      (this._metadata = {
                        api_key: this.apiKey,
          ...
          },
          {
            ...
            get: function () {
              return {
                timestamp: 1782911621363,
                sha: "a7e81f5f25c9da08aa74f824102213a3ad909706",
              };
            },
          },
          {
