    ...
    class h {
      ...
      inject() {
        return (
          this.build(),
          this.format(),
          this.attachDeferredPrefillPostMessage(),
      ...
      getDeferredPrefillPayload() {
        if (!this.options.prefill) return null;
        const { prefill: e } = this.options,
          t = r(e, ["name", "firstName", "lastName", "email"]),
          o = n(t, (e, t) => i(t));
        if (e.customAnswers && "object" == typeof e.customAnswers) {
          const t = e.customAnswers;
          Object.entries(t).forEach(([e, t]) => {
            e.match(/^a\d{1,2}$/) && (o[e] = t);
          });
        }
        return (
          Array.isArray(e.guests) &&
            e.guests.length > 0 &&
            (o.guests = e.guests.filter(Boolean)),
          Object.keys(o).length > 0 ? o : null
        );
      }
      attachDeferredPrefillPostMessage() {
        const e = this.getDeferredPrefillPayload();
        if (!e) return;
        const t = new URL(this.url, window.location.href).origin,
          o = { event: "calendly.prefill", payload: e },
          n = () => {
            var e;
            const n = null == (e = this.node) ? void 0 : e.contentWindow;
            n && n.postMessage(o, t);
          };
        this.node.addEventListener(
          "load",
          () => {
            n(), setTimeout(n, 0), setTimeout(n, 250);
          },
          { once: !0 }
        );
      }
    ...
    var T = Object.defineProperty,
      ...
      M = (e, t, o) =>
        t in e
          ...
          : (e[t] = o);
    const k = (e) => "true" === e.getAttribute("data-resize"),
      N = {},
      U = () => {
        N.popup && N.popup.close();
      },
      _ = (e, t = "PopupText", o = {}) => {
        U(), (N.popup = new j(e, () => delete N.popup, t, o)), N.popup.show();
      },
      I = () => {
        ...
        o(() =>
          ((e) => {
            ...
            const t = ((e) => {
              ...
              o = ((e, t) => {
                for (var o in t || (t = {})) L.call(t, o) && M(e, o, t[o]);
                if (A) for (var o of A(t)) B.call(t, o) && M(e, o, t[o]);
                return e;
              })({ onClick: () => _(e.url, "PopupWidget", e) }, t);
            (N.badge = new m(o)), N.badge.inject();
          })(e)
        );
      },
      W = (e) => {
        o(() => _(e.url, "PopupText", e));
      };
    o(() => {
